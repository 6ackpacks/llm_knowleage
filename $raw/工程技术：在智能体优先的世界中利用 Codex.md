...
## 继续阅读[超越速率限制：扩大 Codex 和 Sora 的访问规模](https://openai.com/index/beyond-rate-limits/)

[

工程

](https://openai.com/index/beyond-rate-limits/)[解锁 Codex 运行框架：我们如何构建 App Server](https://openai.com/index/unlocking-the-codex-harness/)
